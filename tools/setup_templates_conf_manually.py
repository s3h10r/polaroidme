#!/usr/bin/env python3
"""
create a polaroidme.conf output for user-defined --template
...
./setup_templates_manually.py ../polaroidme/templates/fzm-Polaroid.Frame-04.jpg | tee /tmp/polaroidme.conf
2019-07-18 17:22:19,953 - __main__ - INFO - source image ../polaroidme/templates/fzm-Polaroid.Frame-04.jpg size : 26568900
