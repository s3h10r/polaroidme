...
./polaroidme.py --nocrop ./input/DSCF2330.jpg 800 center "--nocrop option (landscape)"
./polaroidme.py --nocrop ./input/DSCF2313.jpg 800 center "--nocrop option (portrait)"
...
./polaroidme.py --crop ./input/DSCF2330.jpg 800 center "--crop option center (landscape)"
./polaroidme.py --crop ./input/DSCF2313.jpg 800 center "--crop option center (portrait)"
feh ./input/DSCF2330.polaroid.png
feh ./input/DSCF2313.polaroid.png
